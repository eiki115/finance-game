...
const quizQuestions = [
    ...
    { question: "欲しいものを買うためには、計画的にお金を貯めることが大切だよ。", answer: true },
    { question: "セールや割引を利用すると同じものでも安く買えることがあるよ。", answer: true },
    { question: "お金をすぐに全部使ってしまうと、後で欲しいものがあっても買えなくなることがあるよ。", answer: true },
    { question: "お金を増やすには、働いたり工夫して物を売ったりする方法があるよ。", answer: true },
    { question: "高い物を買うと必ずお金が増える。", answer: false },
    { question: "本当に欲しい物かどうか考えることで、無駄づかいを減らせるよ。", answer: true },

    // 計算問題(おつり計算)を5問追加
    { question: "300円のものを1000円出して買いました。おつりは700円である。", answer: true },
    { question: "500円のものを1000円出して買いました。おつりは400円である。", answer: false }, // 正しくは500円
    { question: "200円のものを1000円出して買いました。おつりは800円である。", answer: true },
    { question: "750円のものを1000円出して買いました。おつりは250円である。", answer: true },
    { question: "999円のものを1000円出して買いました。おつりは1円である。", answer: true }
];
...
function attemptPurchaseGoal() {
    ...
    if(money >= goalItem.price) {
        ...
        showStatus(`まだ${goalItem.name}は買えないよ！あと${(goalItem.price - money)}円必要だよ！`);
        const btnBack = createButton("戻る", () => {
            showMainMenu();
        });
        controlsElement.appendChild(btnBack);
    }
}
